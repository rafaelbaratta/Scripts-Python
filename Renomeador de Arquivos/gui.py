...
class Gui(ctk.CTk):
    ...
    def build(self):
        ...
        entry_container.pack(fill="both", pady=5, padx=10)
        ...
        self.path_entry.pack(side="left", pady=10, padx=(20, 0))
        ...
        self.directory_button.pack(side="right", pady=10, padx=(0, 20))

        options_container = ctk.CTkFrame(content_container, fg_color=self.COLORS["secondary_bg"])
        options_container.pack(fill="both", pady=5, padx=10)
        ...
        ctk.CTkLabel(
            ...
            font=self.FONTS["text"],
            text_color=self.COLORS["text"],
        ).grid(column=0, row=0, columnspan=2, pady=5, padx=20, sticky="nsew")
        ...
        ctk.CTkLabel(
            ...
            font=self.FONTS["text"],
            text_color=self.COLORS["text"],
        ).grid(column=0, row=1, pady=5, padx=25, sticky="w")
        ...
        ctk.CTkLabel(
            ...
            font=self.FONTS["text"],
            text_color=self.COLORS["text"],
        ).grid(column=0, row=4, pady=5, padx=25, sticky="w")
        ...
        ctk.CTkLabel(
            ...
            font=self.FONTS["text"],
            text_color=self.COLORS["text"],
        ).grid(column=0, row=6, pady=5, padx=25, sticky="w")
        ...
        ctk.CTkLabel(
            ...
            font=self.FONTS["text"],
            text_color=self.COLORS["text"],
        ).grid(column=0, row=8, pady=5, padx=25, sticky="w")
        ...
        self.prefix_entry.grid(column=0, row=9, pady=(0, 10), padx=(20, 5), sticky="nsew")
        ...
        self.suffix_entry.grid(column=1, row=9, pady=(0, 10), padx=(5, 20), sticky="nsew")
        ...
        self.rename_button.pack(side="left", pady=10, padx=(70, 0))
        ...
        self.clear_fields_button.pack(side="right", pady=10, padx=(0, 70))
